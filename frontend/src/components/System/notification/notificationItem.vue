<template>
    <div class="notification-item">
      ...
      <div class="sender">
        <svg class="icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" version="1.1"
            id="Capa_1" width="35px" height="35px" viewBox="0 0 420.827 420.827" xml:space="preserve">
            <g>
                <g>
                    <path fill="#696969"
        ...
        <p class="from">{{ notification.from }}</p>
      </div>
    </div>
  </template>
<script>
...
.notification-item {
    ...
    flex-wrap: wrap;
    transition: ease-in-out background-color 1000ms linear;
}
